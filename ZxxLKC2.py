...
\033[0;36m                              
\033[0;36m =============ZxxLKX CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] ZxxLKXTools | Api Connected [5] | Backup Server [1] | Online User [1000] | Admin: [ZxxLKX] | POWER : {}% [UNSTABLE]\x07".format (powerran))
